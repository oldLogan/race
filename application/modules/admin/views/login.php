...
<div class="login-box">
  <div class="login-logo">
    <a href="/"><b>Drivycar</b>Admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Insira os dados para iniciar sua sessão</p>

    <?php if($this->session->flashdata("success"))  : ?>
        <p class="text-green text-center"><?= $this->session->flashdata("success") ?></p>
    <?php endif ?>                    
    <?php if($this->session->flashdata("danger"))  : ?>
        <p class="text-red text-center"><?= $this->session->flashdata("danger") ?></p>
    <?php endif ?>    

    <form action="/admin/login/autenticar" method="post">
