        ...
        <nav class="navbar navbar-default">
            ...
            <!-- Brand and toggle get grouped for better mobile display -->
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/empresa/dashboard">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="/empresa/dashboard">Início</a></li>
                        <li><a href="/empresa/servicos">Serviços</a></li>
						<!--<li><a href="/empresa/instrutor">Instrutores</a></li>
                        <li><a href="/empresa/veiculos">Veículos</a></li>-->
                        ...
                        <li class="dropdown user-avatar">
                            <a href="/empresa/dashboard" class="dropdown-toggle" data-toggle="dropdown">
                                <img class="img-user img-circle" src="<?=base_url("imagens/" . $usuarioLogado["nomefantasia"] . ".jpg")?>" alt="Sem foto">
                            </a>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/empresa/perfil/dados" class="btn btn-default">Meus dados</a>
                                </div>
